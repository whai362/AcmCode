...
int main()
{
	...
	while(ctr!=27)
	{
		...
		rectangle(10,bas_w+50,10+l,bas_w+50+2*w);
		outtextxy(10+l+5,bas_w+50,"为两张桌子，");
		rectangle(135,bas_w+50,135+l,bas_w+50+w);
		outtextxy(135+l+5,bas_w+50,"为一张桌子，");
		getch();
		closegraph();
		system("cls");
